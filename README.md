...
I will execute releases periodically. These generate PDFs from
all `.ly` files in the repo. PDFs are downloadable under
[Releases](https://github.com/isaacnboyd/music/releases) in the
right hand column.
